"""
幸福之家管理系統 Pro v13.11 - 莫蘭迪柔和護眼版 (修復版)
= 視覺優化 =
...
修復內容：
✅ 修復編輯租客的 TypeError bug (Line 451)
✅ 改用 sqlite3.Row row_factory
✅ 添加 None 檢查防止崩潰
功能邏輯保持完整架構不變。
"""
...
# ============================================================================
# 數據庫類 - 主要修復在 get_tenant_by_id 方法
# ============================================================================
class RentalDB:
    ...
    # ====================================================================
    # 修復方法：get_tenant_by_id (Line 451)
    # ====================================================================
...
def display_card(title: str, value: str, color: str = "blue"):
    """莫蘭迪風格卡片 - 使用低飽和度色彩，減少視覺疲勞"""
    colors = {"blue": "#f0f4f8", "green": "#edf2f0", "orange": "#fdf3e7", "red": "#fbeaea"}
    border_colors = {"blue": "#98c1d9", "green": "#99b898", "orange": "#e0c3a5", "red": "#e5989b"}
    text_color = "#4a5568"
    value_color = "#2d3748"
